                            ...
                            <div class="card mt-3" id="mycard">
                                ...
                                <div class="card-footer bg-dark">
                                    ...
                                    <a href="{{route('laptops.show',$laptop->id)}}"
                                       class="btn btn-warning btn-lg btn-block "><i class="fas fa-cart-plus"
